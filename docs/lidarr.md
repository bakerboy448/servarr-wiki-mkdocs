...
- [:fontawesome-solid-play:&emsp;Library](lidarr/library.md)
- [:fontawesome-solid-calendar-alt:&emsp;Calendar](lidarr/calendar.md)
- [:fontawesome-solid-clock:&emsp;Activity](lidarr/activity.md)
- [:fontawesome-solid-search-minus:&emsp;Wanted](lidarr/wanted.md)
- [:fontawesome-solid-cogs:&emsp;Settings](lidarr/settings.md)
- [:fontawesome-solid-laptop:&emsp;System](lidarr/system.md)
- [:fontawesome-solid-scroll:&emsp;Custom Scripts](lidarr/custom-scripts.md)
- [:fontawesome-solid-gifts:&emsp;Tips and Tricks](lidarr/tips-and-tricks.md)
