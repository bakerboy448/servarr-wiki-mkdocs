...
- Sonarr uses the RSS feed to pick up new releases as they come along. [See the FAQ for more information](faq.md#how-does-sonarr-find-episodes)
...
- RSS Sync - This will run the RSS Sync. This can be changed in Settings => Indexers => Options. More information on the RSS function can be found on our [FAQ](faq.md)
...
!!! info
    If you're looking for how to back/restore your Sonarr instance click [the Sonarr backup FAQ](faq.md).
