...
If you're looking to trigger a custom script, you can find more details here. Scripts are added to Sonarr via the [Connect Settings](settings.md#connections).
