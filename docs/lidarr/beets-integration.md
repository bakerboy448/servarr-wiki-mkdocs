...
- [Custom Scripts](../lidarr/custom-scripts.md) — environment variables available to scripts and how to register them
- [Settings → Metadata](../lidarr/settings.md#metadata) — Write Tags setting and metadata consumer options
