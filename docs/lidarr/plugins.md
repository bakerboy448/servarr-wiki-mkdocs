...
- See the [Installation Docs](installation.md) and simply change the branch in the url noted in the install docs from `master` to `nightly`, otherwise following the docs as-is.
