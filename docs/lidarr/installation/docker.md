...
See the [Docker Guide](../../docker-guide.md) and [TRaSH's Docker Tutorial](https://trash-guides.info/hardlinks/) for how to set up Docker Compose.
...
!!! info
    For a more detailed explanation of these issues, see [The Best Docker Setup and Docker Guide](../../docker-guide.md).
