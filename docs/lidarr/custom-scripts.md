...
- [Settings → Connect](../lidarr/settings.md#connections) — where you register scripts in the Lidarr UI
- [Beets Integration](../lidarr/beets-integration.md) — using a custom script to invoke beets for tag enrichment after import
