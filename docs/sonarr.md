...
- [:fontawesome-solid-plus-square:&emsp;Installation Guide](sonarr/installation.md)
- [:fontawesome-solid-book-open:&emsp;Quick Start Guide](sonarr/quick-start-guide.md)
...
- [:fontawesome-solid-play:&emsp;Library](sonarr/library.md)
- [:fontawesome-solid-calendar-alt:&emsp;Calendar](sonarr/calendar.md)
- [:fontawesome-solid-clock:&emsp;Activity](sonarr/activity.md)
- [:fontawesome-solid-search-minus:&emsp;Wanted](sonarr/wanted.md)
- [:fontawesome-solid-cogs:&emsp;Settings](sonarr/settings.md)
- [:fontawesome-solid-laptop:&emsp;System](sonarr/system.md)
- [:fontawesome-solid-scroll:&emsp;Custom Scripts](sonarr/custom-scripts.md)
- [:fontawesome-solid-gifts:&emsp;Tips and Tricks](sonarr/tips-and-tricks.md)
