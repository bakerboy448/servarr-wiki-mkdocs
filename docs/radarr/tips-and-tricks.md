...
- [TRasH has a guide](https://trash-guides.info/Radarr/) on how to use [Radarr => Settings => Custom Formats](settings.md#custom-formats) as well as a shared repository of Custom Formats.
