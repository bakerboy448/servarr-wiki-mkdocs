...
- Chances are that your Discover recommendations will be sparse if you have a new installation with few or no movies. You will need to add library content to fuel recommendation direction. You have several options:
  ...
  1. Click on the [Add Lists](settings.md#lists) button to add a list to Radarr. Additional information about lists can be found at the [More Info (Supported)](faq.md#what-are-lists-and-what-can-they-do-for-me) page for this section.
...
- Once you've added a movie by one of the three options listed above, you will be presented with different movies to discover.
    ...
    1. Do you want Radarr to exclude these movies from any lists that would be imported? ([More info](settings.md#list-exclusion))
