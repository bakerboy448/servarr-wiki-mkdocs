...
- [:fontawesome-solid-play:&emsp;Library](readarr/library.md)
- [:fontawesome-solid-calendar-alt:&emsp;Calendar](readarr/calendar.md)
- [:fontawesome-solid-clock:&emsp;Activity](readarr/activity.md)
- [:fontawesome-solid-search-minus:&emsp;Wanted](readarr/wanted.md)
- [:fontawesome-solid-cogs:&emsp;Settings](readarr/settings.md)
- [:fontawesome-solid-laptop:&emsp;System](readarr/system.md)
- [:fontawesome-solid-scroll:&emsp;Custom Scripts](readarr/custom-scripts.md)
- [:fontawesome-solid-gifts:&emsp;Tips and Tricks](readarr/tips-and-tricks.md)
