...
Two things to keep in mind are that Lidarr requires read and write access to your download client's download directory and whatever folder you'll configure as your root (library) folder. Ideally each app is running as its own user and common group of `media` with permissions of `775` and `664` which is a UMask of `002`
...
#!/bin/sh
#
# Author: Michiel van Baak <redacted-c6cd235fe5@users.noreply.github.com>
