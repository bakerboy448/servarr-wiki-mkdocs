...
- Custom Lists {#whisparrlistimport}
- IMDb Lists {#imdblistimport}
  - To add your IMDb Watchlist, go to your list and click edit. Make sure privacy setting is set to public. In the address bar you will find the `lsxxxxxx` number that you will need to enter into Whisparr

    1. Go to your IMDB List Settings
    1. Ensure Privacy is set to `Public` (i.e. `Disabled)`
    1. Use the `ls` number within the URL

- ![imdb-list-ls.png](/assets/whisparr/imdb-list-ls.png)
- Whisparr {#whisparrimport}
...
- Kodi (XBMC) / Emby {#xbmcmetadata}
  ...
  - Metadata Language - Select the language Whisparr should use to write the metadata if available in that language
